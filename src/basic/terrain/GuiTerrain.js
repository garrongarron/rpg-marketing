...
panel.add(noiseGenerator.params, 'height', 0.0, 100, 1).listen().onChange(() => terrain.updateAgain())
panel.add(noiseGenerator.params, 'scale', 0.0, 100, 0.01).listen().onChange(() => terrain.updateAgain())
